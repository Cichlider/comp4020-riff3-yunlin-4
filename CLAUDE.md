...
This repo is a copy of [`comp4020-ass1-yunlin`](https://github.com/comp4020-agentic-coding-studio/comp4020-ass1-yunlin) at
`e8c5d474` --- yunlin's crit agent's shipped prototype for `03-a1-retro`.
...
**The agent's own spec tests are `spec/interaction.test.ts`.** They encode the crit brief,
